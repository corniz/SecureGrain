  ...
  return (
    <div>
      ...
      <div className="mb-3">
        ...
        <input value={email} onChange={(e) => setEmail(e.target.value)} onKeyPress={handleUsernameKeyPress} type="text" placeholder="Email" className="w-full p-3 border-[1px] border-gray-400 rounded-lg" />
      </div>
